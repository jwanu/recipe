...
const RecipePage = () => {
  ...
  const [equip, setEquip] = useState(mockEquip.equipment);
  const [priceBreak, setPB] = useState(mockPB);
  const [instructions, setInst] = useState(mockInst);

//   useEffect(() => {
//     const searching = async () => {
//       try {
//         const resDetail = await axios.get(`https://api.spoonacular.com/recipes/${id}/information?includeNutrition=true&${API_KEY}`);
//         const resEquip = await axios.get(`https://api.spoonacular.com/recipes/${id}/equipmentWidget.json?${API_KEY}`);
//         const resPB = await axios.get(`https://api.spoonacular.com/recipes/${id}/priceBreakdownWidget.json?${API_KEY}`);
//         const resInst = await axios.get(`https://api.spoonacular.com/recipes/${id}/analyzedInstructions?${API_KEY}`);
//         console.log(resDetail.data);
//         console.log(resEquip.data.equipment);
//         console.log(resPB.data);
//         console.log(resInst.data);
//         setDetail(resDetail.data);
//         setEquip(resEquip.data.equipment);
//         setPB(resPB.data);
...
//   }, []);
  ...
  return (
    <>
      ...
      <RecipeTemplate detail={detail} equip={equip} pb={priceBreak} inst={instructions} />
    </>
  );
};
//
