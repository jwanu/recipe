...
import { RiUser6Line, RiTimerLine, RiHeartLine, RiLeafLine, RiBarChartBoxLine, RiMoneyDollarCircleLine } from 'react-icons/ri';
import skeleton from '../../styles/skeleton';
import { useDispatch } from 'react-redux';
import { setCurrent } from '../../modules/recipeNow';
...
const BasicInfo = ({ detail, loading }) => {
  ...
  dispatch(setCurrent(detail.id,detail.title,detail.spoonacularScore,detail.readyInMinutes,detail.servings));
  return (
    <>
      ...
      <SpecialtyIcons>
          ...
          <div className="specialty">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              <g data-name="Dairy Product">
                ...
                <path d="M169.6 128l-9.6 16v368H16a16 16 0 01-16-16V144a32.956 32.956 0 0128.259-16z" fill="#e2dbd5" />
                ...
                <path
                  ...
                  fill="#f09b73"
                />
                <path d="M272 311.394V504a8 8 0 008 8h160a8 8 0 008-8V200a87.086 87.086 0 00-1.051-13.424A208.119 208.119 0 01272 311.394z" fill="#e58b6c" />
                ...
                <path
                  ...
                  fill="#f8e868"
                />
                <path d="M383.466 462.463l-41.412-107.558a200.121 200.121 0 01-163.56 116.236 146.517 146.517 0 00203.083-.067 8 8 0 001.889-8.611z" fill="#f6e23d" />
                ...
                <path d="M336.033 328l16 176.724A8 8 0 00360 512h112a8 8 0 007.967-7.276l16-176.724z" fill="#81c784" />
                ...
                <path d="M36.09 357.189C54.4 399.027 128 386.274 128 336c0-5.617-2.087-12.839-5.4-20.636-13.267 32.691-51.368 52.063-86.51 41.825z" fill="#efebe8" />
                <path d="M504 336H328a8 8 0 010-16h176a8 8 0 010 16z" fill="#49ad4d" />
                <path d="M348 460.142l4.036 44.582A8 8 0 00360 512h112a8 8 0 007.967-7.276l12.354-136.453A172 172 0 01348 460.142z" fill="#66bb6a" />
              </g>
            </svg>
        ...
        {detail.glutenFree && (
          <div className="specialty">
            <svg viewBox="0 0 511.896 511.896" xmlns="http://www.w3.org/2000/svg">
              <path d="M430.207 178.426c-26.713-26.713-70.024-26.713-96.737 0l-20.729 20.729 56.046 56.046c26.713 26.713 70.024 26.713 96.737 0l20.729-20.729z" fill="#ffc239" />
              <path d="M333.47 81.689l-56.046-56.046-20.729 20.729c-26.713 26.713-26.713 70.024 0 96.737l56.046 56.046 20.729-20.729c26.713-26.713 26.713-70.024 0-96.737z" fill="#ffe04a" />
              <path d="M320.1 288.533c-26.713-26.713-70.024-26.713-96.737 0l-20.729 20.729 56.046 56.046c26.713 26.713 70.024 26.713 96.737 0l20.729-20.729z" fill="#ffc239" />
              <path d="M223.363 191.796l-56.046-56.046-20.729 20.729c-26.713 26.713-26.713 70.024 0 96.737l56.046 56.046 20.729-20.729c26.713-26.713 26.713-70.024 0-96.737z" fill="#ffe04a" />
              <path d="M209.994 398.64c-26.713-26.713-70.024-26.713-96.737 0l-20.729 20.729 56.046 56.046c26.713 26.713 70.024 26.713 96.737 0l20.729-20.729z" fill="#ffc239" />
              <path
                ...
                fill="#ffe04a"
              />
              <path d="M458.728 127.028h-73.864L511.889.004l.007 73.857c0 29.359-23.809 53.167-53.168 53.167z" fill="#ffc239" />
        ...
        {detail.ketogenic && (
          <div className="specialty">
            <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M21.684 38.922C20.543 38.334 19.302 38 18 38c-5.523 0-10 5.82-10 13 0 4.344 1.645 7.449 4.164 9.232C18.225 57.335 22.423 51.166 22.423 44c0-1.765-.266-3.466-.739-5.078z" fill="#e7e4dd" />
              <path
              ...
              <path d="M48.241 36.611A8.97 8.97 0 0045 36a9 9 0 00-9 9 8.95 8.95 0 001.836 5.432 32.076 32.076 0 0010.405-13.821z" fill="#e39854" />
              <path
              ...
              <path d="M52.999 11.998h-2A6.006 6.006 0 0045 5.999v-2c4.411 0 7.999 3.588 7.999 7.999z" fill="#669e4f" />
              <path d="M29.192 7.757a6.005 6.005 0 00-8.485 0l-1.415-1.415c3.12-3.117 8.194-3.119 11.314 0z" fill="#96cc7f" />
              ...
              <path d="M8 35a6 6 0 006-6v-2a6 6 0 00-6 6zM7.575 17c-2.099-2.209-2.099-5.791 0-8l2.851-3c2.099 2.209 2.099 5.791 0 8z" fill="#c18e59" />
              <path d="M20 35h-4a4 4 0 014-4h4a4 4 0 01-4 4z" fill="#976947" />
              <path d="M18 46a5.998 5.998 0 00-1.904 11.686 17.974 17.974 0 005.966-10.093A5.971 5.971 0 0018 46z" fill="#f7d881" />
            </svg>
            <span>KETO</span>
          </div>
        )}
        {detail.vegan && (
          <div className="specialty">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              <circle cx="349.637" cy="118.192" fill="#c53232" transform="rotate(-69.03 349.427 118.195)" r="106.522" />
              <path d="M349.637 174.359c-30.97 0-56.167-25.196-56.167-56.167s25.197-56.167 56.167-56.167c30.971 0 56.168 25.196 56.168 56.167s-25.197 56.167-56.168 56.167z" fill="#dd4e4e" />
              <path
              ...
              <path
                ...
                fill="#a5e887"
              />
              <path d="M412.21 224.237l10.606 10.607 10.607 10.606-137.154 137.154-10.606-10.606-10.607-10.607z" fill="#e1fd9f" />
              <g>
                <circle cx="121.866" cy="307.369" fill="#dd4e4e" transform="rotate(-69.03 121.742 307.227)" r="106.522" />
                <path d="M121.865 363.536c-30.97 0-56.167-25.196-56.167-56.167s25.197-56.167 56.167-56.167c30.971 0 56.168 25.196 56.168 56.167s-25.197 56.167-56.168 56.167z" fill="#e38651" />
                <g>
                  <path
              ...
              <path d="M0 397.118v11.996c0 50.377 40.839 91.216 91.216 91.216H256l22.95-53.873L256 397.118z" fill="#e1ebf0" />
      ...
      <Summary dangerouslySetInnerHTML={{ __html: detail.summary }} />
      <IngredientSection>
        <h3 className="header">Ingredients</h3>
        <div className="ingredients">
